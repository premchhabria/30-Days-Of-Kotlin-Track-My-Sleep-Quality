...
public final class SleepDatabase_Impl extends SleepDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsDailySleepQualityTable.put("nightId", new TableInfo.Column("nightId", "INTEGER", true, 1));
        _columnsDailySleepQualityTable.put("start_time_milli", new TableInfo.Column("start_time_milli", "INTEGER", true, 0));
        _columnsDailySleepQualityTable.put("end_time_milli", new TableInfo.Column("end_time_milli", "INTEGER", true, 0));
        _columnsDailySleepQualityTable.put("quality_rating", new TableInfo.Column("quality_rating", "INTEGER", true, 0));
        ...
        if (! _infoDailySleepQualityTable.equals(_existingDailySleepQualityTable)) {
          throw new IllegalStateException("Migration didn't properly handle daily_sleep_quality_table(com.example.android.trackmysleepquality.database.SleepNight).\n"
  ...
  protected InvalidationTracker createInvalidationTracker() {
    return new InvalidationTracker(this, "daily_sleep_quality_table");
  }
